...
export function PostCard({ post }) {
    return <div className="col-lg-4 col-md-4 col-sm-4 product-list-col">
        ...
        <Link href={`/product/domestic-detail/${post?.id}`} className="product-list">
            <div className="product-img-holder position-relative"><div className="product-holder position-relative"><ExportedImage src={post?.productURL} width={300} height={300} alt={post?.name}/></div>
